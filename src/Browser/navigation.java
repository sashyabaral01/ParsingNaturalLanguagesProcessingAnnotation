...
public class Navigation extends HBox
{
	...
	public Navigation(WebView webView, String homePageUrl, boolean goToHomePage) 
	{
		// Set Spacing
		this.setSpacing(4);
		...
		fileChooser.getExtensionFilters().addAll(new ExtensionFilter("HTML Files", "*.html", "*.htm","*.txt"));
